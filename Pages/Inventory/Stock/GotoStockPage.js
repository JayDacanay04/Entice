...
export default class GotoStockPage {
  constructor(page) {
    this.page = page
  }
  ...
  async StockPage() {
    ...
    await this.page.getByRole('treeitem', { name: 'Inventory' }).locator('div').nth(4).click();
    await this.page.getByRole('treeitem', { name: 'Item', exact: true }).click();
    await this.page.getByRole('treeitem', { name: 'Stock', exact: true }).click();

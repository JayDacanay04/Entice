...
export default class AddNewContact {
  ...
  // Locators Contact tab
  // EntityDropdown = this.page.locator('dxbl-form-layout-item').filter({ hasText: 'Entity*' }).getByLabel('Open or close the drop-down');
